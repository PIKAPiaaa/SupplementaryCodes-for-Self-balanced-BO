...
# Construct a gain-sublattice-polarized initial state.
# The symmetric superposition of the k = pi/2 and k = 3*pi/2
# wave packets cancels on the odd array indices, and remains nonzero
# only on the even array indices, which represent the gain sublattice
# carrying the on-site potential +i*gamma.
